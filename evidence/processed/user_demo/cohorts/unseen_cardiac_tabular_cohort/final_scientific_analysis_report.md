...
**Date Generated:** 2026-08-15T14:55:43.176418+00:00  
**Execution Runtime:** 1.24 seconds  
...
- **Discovered Modalities:** `['tabular']`
- **Patient/Entity Identifier:** `patient_record_id`
- **Target Prediction Variable:** `adverse_cardiac_event`
...
| :--- | :---: | :---: | :---: |
| **Mean ROC-AUC** | **`0.5625 ± 0.3680`** | `0.5625 ± 0.3680` | `+0.0000` |
| **Brier Score Loss** | **`0.2294`** | `0.2294` | **`0.0000`** *(lower is better)* |
| **Mean Accuracy** | **`0.5833`** | `0.5833` | `+0.0000` |
| **Mean F1 Score** | **`0.4722`** | `0.4722` | `+0.0000` |
...
## 7. Artifact Manifest
All generated assets are stored in `evidence\processed\user_demo\cohorts\unseen_cardiac_tabular_cohort`:
