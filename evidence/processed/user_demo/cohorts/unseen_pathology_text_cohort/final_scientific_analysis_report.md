...
**Date Generated:** 2026-08-15T14:55:49.298912+00:00  
**Execution Runtime:** 2.47 seconds  
...
- **Discovered Modalities:** `['text']`
- **Patient/Entity Identifier:** `patient_record_id`
- **Target Prediction Variable:** `high_grade_dysplasia`
...
| **Brier Score Loss** | **`0.2095`** | `0.2095` | **`0.0000`** *(lower is better)* |
| **Mean Accuracy** | **`0.8333`** | `0.8333` | `+0.0000` |
| **Mean F1 Score** | **`0.6667`** | `0.6667` | `+0.0000` |
...
## 7. Artifact Manifest
All generated assets are stored in `evidence\processed\user_demo\cohorts\unseen_pathology_text_cohort`:
