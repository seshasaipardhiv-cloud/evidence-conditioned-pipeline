...
**Date Generated:** 2026-08-15T11:36:45.122927+00:00  
**Execution Runtime:** 12.31 seconds  
...
| :--- | :---: | :---: | :---: |
| **Mean ROC-AUC** | **`0.3333 ± 0.4714`** | `0.0000 ± 0.0000` | `+0.3333` |
| **Brier Score Loss** | **`0.2665`** | `0.3093` | **`-0.0428`** *(lower is better)* |
| **Mean Accuracy** | **`0.3611`** | `0.2222` | `+0.1389` |
| **Mean F1 Score** | **`0.3333`** | `0.0952` | `+0.2381` |
...
## 7. Artifact Manifest
All generated assets are stored in `evidence\processed\user_demo`:
